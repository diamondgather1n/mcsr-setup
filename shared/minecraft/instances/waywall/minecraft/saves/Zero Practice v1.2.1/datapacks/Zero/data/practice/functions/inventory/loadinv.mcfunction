...
# load inventory
execute if score randomize_act settings matches 2 run data modify block 0 0 0 Items set from storage practice:loadouts selected.inventory
execute if score randomize_act settings matches 0..1 run data modify block 0 0 0 Items set from storage practice:loadouts randomizer.inventory
