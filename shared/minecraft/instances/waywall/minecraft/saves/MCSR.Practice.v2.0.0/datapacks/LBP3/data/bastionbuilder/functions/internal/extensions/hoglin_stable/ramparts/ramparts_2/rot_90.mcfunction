...
execute if score id_piglins bastion.settings matches 1.. positioned ~-13 ~3 ~7 as @e[type=piglin, tag=bastion_mob, dx=2, dy=0, dz=4] run data modify entity @s CustomName set value '{"text":"ramparts/ramparts_2","color":"yellow"}'