clone ~ ~ ~ ~ ~1 ~ ~ 254 ~
setblock ~ ~ ~ structure_block{mode:"LOAD", rotation:"COUNTERCLOCKWISE_90", name:"sp.fortress:bridge/small_crossing"}
...
execute positioned ~6 ~-1 ~-6 run function sp.fortress:internal/fill_support
