...
execute if score id_piglins bastion.settings matches 1.. positioned ~3 ~4 ~2 as @e[type=piglin, tag=bastion_mob, dx=33, dy=12, dz=37] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'