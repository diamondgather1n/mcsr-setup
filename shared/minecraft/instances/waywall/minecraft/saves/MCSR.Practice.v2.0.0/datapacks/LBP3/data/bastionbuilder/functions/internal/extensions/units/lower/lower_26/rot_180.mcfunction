...
execute if score id_piglins bastion.settings matches 1.. positioned ~-40 ~4 ~-34 as @e[type=piglin, tag=bastion_mob, dx=31, dy=12, dz=33] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'