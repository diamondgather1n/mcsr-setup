...
execute if score id_piglins bastion.settings matches 1.. positioned ~-26 ~1 ~-44 as @e[type=piglin, tag=bastion_mob, dx=23, dy=18, dz=43] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'