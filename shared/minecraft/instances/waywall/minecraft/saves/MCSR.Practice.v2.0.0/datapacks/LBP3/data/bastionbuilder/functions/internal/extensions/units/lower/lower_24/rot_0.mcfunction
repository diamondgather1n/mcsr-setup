...
execute if score id_piglins bastion.settings matches 1.. positioned ~3 ~2 ~12 as @e[type=piglin, tag=bastion_mob, dx=38, dy=14, dz=29] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'