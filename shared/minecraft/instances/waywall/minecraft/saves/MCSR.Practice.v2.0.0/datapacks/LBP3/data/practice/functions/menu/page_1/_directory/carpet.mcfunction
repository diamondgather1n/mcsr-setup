...
# Piedar removed
execute if score selection chest_menu matches 6 run scoreboard players set piedar settings 0
execute if score selection chest_menu matches 7 run scoreboard players set piedar_dist settings 0
...
# Keep piedar values forced off
scoreboard players set piedar settings 0
scoreboard players set piedar_dist settings 0
