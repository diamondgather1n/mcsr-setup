...
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:1} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 1
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:2} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 2
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:3} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 3
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:4} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 4
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:5} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 5
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:6} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 6
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:7} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 7
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:8} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 8
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:9} 0
execute if score bool chest_menu matches 1 run scoreboard players set selection chest_menu 9
execute store success score bool chest_menu run clear @s #practice:chest_menu{selection:10} 0
