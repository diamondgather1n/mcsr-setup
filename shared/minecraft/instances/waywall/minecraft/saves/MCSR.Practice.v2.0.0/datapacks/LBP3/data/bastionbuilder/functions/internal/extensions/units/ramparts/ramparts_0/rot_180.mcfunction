...
execute if score id_piglins bastion.settings matches 1.. positioned ~-10 ~17 ~-12 as @e[type=piglin, tag=bastion_mob, dx=3, dy=0, dz=7] run data modify entity @s CustomName set value '{"text":"ramparts/ramparts_0","color":"yellow"}'