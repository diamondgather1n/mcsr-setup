...
execute if score id_piglins bastion.settings matches 1.. positioned ~4 ~7 ~1 as @e[type=piglin, tag=bastion_mob, dx=22, dy=12, dz=45] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'