clone ~ ~ ~ ~ ~1 ~ ~ 254 ~
setblock ~ ~ ~ structure_block{mode:"LOAD", rotation:"COUNTERCLOCKWISE_90", name:"sp.fortress:corridor/stairs"}
...
execute positioned ~3 ~-1 ~-9 run function sp.fortress:internal/fill_support
execute positioned ~4 ~-1 ~-9 run function sp.fortress:internal/fill_support
