...
execute positioned ~ ~13 ~-2 run function bastionbuilder:internal/place/bridge/rampart_plates/plate_0/rot_90
...
execute if score id_piglins bastion.settings matches 1.. positioned ~-11 ~4 ~3 as @e[type=piglin, tag=bastion_mob, dx=6, dy=15, dz=10] run data modify entity @s CustomName set value '{"text":"ramparts/rampart_1","color":"yellow"}'