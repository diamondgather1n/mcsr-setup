...
execute if score id_piglins bastion.settings matches 1.. positioned ~9 ~2 ~-41 as @e[type=piglin, tag=bastion_mob, dx=29, dy=14, dz=32] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'