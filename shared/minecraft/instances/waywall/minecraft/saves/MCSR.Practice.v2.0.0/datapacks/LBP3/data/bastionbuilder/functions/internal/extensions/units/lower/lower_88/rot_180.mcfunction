...
execute if score id_piglins bastion.settings matches 1.. positioned ~-39 ~2 ~-40 as @e[type=piglin, tag=bastion_mob, dx=36, dy=14, dz=38] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'