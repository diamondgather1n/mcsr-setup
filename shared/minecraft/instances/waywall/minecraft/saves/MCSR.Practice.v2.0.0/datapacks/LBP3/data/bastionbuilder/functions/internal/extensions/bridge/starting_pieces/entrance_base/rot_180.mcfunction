...
execute if score id_piglins bastion.settings matches 1.. positioned ~-11 ~25 ~-19 as @e[type=piglin, tag=bastion_mob, dx=9, dy=1, dz=4] run data modify entity @s CustomName set value '{"text":"starting_pieces/entrance_base","color":"yellow"}'