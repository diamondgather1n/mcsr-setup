...
execute if score id_piglins bastion.settings matches 1.. positioned ~5 ~17 ~-10 as @e[type=piglin, tag=bastion_mob, dx=7, dy=0, dz=3] run data modify entity @s CustomName set value '{"text":"ramparts/ramparts_0","color":"yellow"}'