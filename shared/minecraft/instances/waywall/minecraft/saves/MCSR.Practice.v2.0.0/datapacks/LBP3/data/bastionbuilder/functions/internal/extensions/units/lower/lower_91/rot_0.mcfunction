...
execute if score id_piglins bastion.settings matches 1.. positioned ~6 ~2 ~4 as @e[type=piglin, tag=bastion_mob, dx=33, dy=14, dz=39] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'