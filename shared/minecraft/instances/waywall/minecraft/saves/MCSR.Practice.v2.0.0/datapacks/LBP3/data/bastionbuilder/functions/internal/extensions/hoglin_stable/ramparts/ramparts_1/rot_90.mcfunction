...
execute positioned ~ ~13 ~-2 run function bastionbuilder:internal/place/hoglin_stable/rampart_plates/rampart_plate_1/rot_90
...
execute if score id_piglins bastion.settings matches 1.. positioned ~-12 ~4 ~3 as @e[type=piglin, tag=bastion_mob, dx=9, dy=15, dz=7] run data modify entity @s CustomName set value '{"text":"ramparts/ramparts_1","color":"yellow"}'