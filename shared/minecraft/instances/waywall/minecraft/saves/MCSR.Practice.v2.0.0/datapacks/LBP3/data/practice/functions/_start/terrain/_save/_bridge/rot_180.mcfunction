...
setblock ~-47 ~-1 ~-47 structure_block{mode:"SAVE", ignoreEntities:0b, posY:48, sizeX:48, sizeY:30, sizeZ:48, name:"practice:rerun_terrain/0_1_0"}

setblock ~-47 ~-2 ~-83 structure_block{mode:"SAVE", ignoreEntities:0b, posY:2, sizeX:48, sizeY:47, sizeZ:36, name:"practice:rerun_terrain/0_0_1"}
setblock ~-47 ~-1 ~-83 structure_block{mode:"SAVE", ignoreEntities:0b, posY:48, sizeX:48, sizeY:30, sizeZ:36, name:"practice:rerun_terrain/0_1_1"}

setblock ~-74 ~-2 ~-47 structure_block{mode:"SAVE", ignoreEntities:0b, posY:2, sizeX:27, sizeY:47, sizeZ:48, name:"practice:rerun_terrain/1_0_0"}
setblock ~-74 ~-1 ~-47 structure_block{mode:"SAVE", ignoreEntities:0b, posY:48, sizeX:27, sizeY:30, sizeZ:48, name:"practice:rerun_terrain/1_1_0"}

setblock ~-74 ~-2 ~-83 structure_block{mode:"SAVE", ignoreEntities:0b, posY:2, sizeX:27, sizeY:47, sizeZ:36, name:"practice:rerun_terrain/1_0_1"}
setblock ~-74 ~-1 ~-83 structure_block{mode:"SAVE", ignoreEntities:0b, posY:48, sizeX:27, sizeY:30, sizeZ:36, name:"practice:rerun_terrain/1_1_1"}
