...
execute if score id_piglins bastion.settings matches 1.. positioned ~4 ~1 ~2 as @e[type=piglin, tag=bastion_mob, dx=20, dy=18, dz=41] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'