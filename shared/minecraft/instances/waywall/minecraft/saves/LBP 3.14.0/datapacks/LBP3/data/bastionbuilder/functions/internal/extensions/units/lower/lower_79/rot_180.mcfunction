...
execute if score id_piglins bastion.settings matches 1.. positioned ~-39 ~4 ~-41 as @e[type=piglin, tag=bastion_mob, dx=36, dy=12, dz=36] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'