...
execute if score id_piglins bastion.settings matches 1.. positioned ~2 ~2 ~2 as @e[type=piglin, tag=bastion_mob, dx=39, dy=14, dz=39] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'