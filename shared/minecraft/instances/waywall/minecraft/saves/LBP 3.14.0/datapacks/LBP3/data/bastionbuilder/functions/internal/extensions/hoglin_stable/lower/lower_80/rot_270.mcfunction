...
execute if score id_piglins bastion.settings matches 1.. positioned ~10 ~1 ~-26 as @e[type=piglin, tag=bastion_mob, dx=36, dy=18, dz=23] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'