...
execute if score id_piglins bastion.settings matches 1.. positioned ~-41 ~2 ~-37 as @e[type=piglin, tag=bastion_mob, dx=38, dy=14, dz=35] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'