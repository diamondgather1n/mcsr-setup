...
execute if score id_piglins bastion.settings matches 1.. positioned ~3 ~1 ~11 as @e[type=piglin, tag=bastion_mob, dx=22, dy=18, dz=34] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'