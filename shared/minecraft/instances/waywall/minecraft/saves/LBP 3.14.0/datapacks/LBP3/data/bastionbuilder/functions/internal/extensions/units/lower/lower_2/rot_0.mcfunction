...
execute if score id_piglins bastion.settings matches 1.. positioned ~4 ~4 ~8 as @e[type=piglin, tag=bastion_mob, dx=34, dy=12, dz=33] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'