...
execute if score id_piglins bastion.settings matches 1.. positioned ~-14 ~3 ~2 as @e[type=piglin, tag=bastion_mob, dx=11, dy=16, dz=11] run data modify entity @s CustomName set value '{"text":"walls/wall_base","color":"yellow"}'