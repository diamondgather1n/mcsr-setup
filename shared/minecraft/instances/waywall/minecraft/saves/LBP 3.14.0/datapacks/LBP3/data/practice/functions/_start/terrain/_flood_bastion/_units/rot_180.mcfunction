execute if score units_lava settings matches 0 run setblock ~1 ~-1 ~-19 structure_block{mode:"LOAD", name:"practice:lava_housing", rotation:"COUNTERCLOCKWISE_90", posY:1}
execute if score units_lava settings matches 0 run setblock ~1 ~-2 ~-19 redstone_block
execute if score units_lava settings matches 0 run clone ~1 ~-1 ~-20 ~1 ~-1 ~-20 ~1 ~-2 ~-19
