clone ~ ~ ~ ~ ~1 ~ ~ 254 ~
setblock ~ ~ ~ structure_block{mode:"LOAD", rotation:"COUNTERCLOCKWISE_90", name:"sp.fortress:corridor/balcony"}
...
execute positioned ~6 ~-1 ~-5 run function sp.fortress:internal/fill_support
execute positioned ~7 ~-1 ~-5 run function sp.fortress:internal/fill_support
execute positioned ~8 ~-1 ~-5 run function sp.fortress:internal/fill_support
