...
execute if score id_piglins bastion.settings matches 1.. positioned ~-25 ~1 ~-34 as @e[type=piglin, tag=bastion_mob, dx=21, dy=18, dz=33] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'