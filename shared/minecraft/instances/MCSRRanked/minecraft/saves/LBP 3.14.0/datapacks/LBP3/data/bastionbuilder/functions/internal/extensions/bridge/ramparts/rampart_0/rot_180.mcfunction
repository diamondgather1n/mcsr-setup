...
execute if score id_piglins bastion.settings matches 1.. positioned ~-14 ~3 ~-9 as @e[type=piglin, tag=bastion_mob, dx=1, dy=2, dz=3] run data modify entity @s CustomName set value '{"text":"ramparts/rampart_0","color":"yellow"}'