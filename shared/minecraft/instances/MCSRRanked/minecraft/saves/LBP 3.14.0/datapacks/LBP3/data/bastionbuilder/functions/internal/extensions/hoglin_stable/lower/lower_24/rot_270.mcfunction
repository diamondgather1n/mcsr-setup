...
execute if score id_piglins bastion.settings matches 1.. positioned ~2 ~1 ~-7 as @e[type=piglin, tag=bastion_mob, dx=41, dy=12, dz=4] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'