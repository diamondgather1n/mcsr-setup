...
execute if score id_piglins bastion.settings matches 1.. positioned ~-41 ~4 ~-39 as @e[type=piglin, tag=bastion_mob, dx=38, dy=12, dz=36] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'