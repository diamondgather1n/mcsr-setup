...
execute if score id_piglins bastion.settings matches 1.. positioned ~-36 ~2 ~2 as @e[type=piglin, tag=bastion_mob, dx=34, dy=14, dz=36] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'