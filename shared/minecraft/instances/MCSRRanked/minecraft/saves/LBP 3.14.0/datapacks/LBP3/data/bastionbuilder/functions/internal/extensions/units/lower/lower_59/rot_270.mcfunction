...
execute if score id_piglins bastion.settings matches 1.. positioned ~12 ~4 ~-40 as @e[type=piglin, tag=bastion_mob, dx=27, dy=12, dz=37] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'