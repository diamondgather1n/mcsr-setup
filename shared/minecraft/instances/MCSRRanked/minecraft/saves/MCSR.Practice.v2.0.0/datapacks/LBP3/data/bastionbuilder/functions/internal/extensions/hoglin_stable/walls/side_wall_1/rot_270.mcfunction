...
execute if score id_piglins bastion.settings matches 1.. positioned ~4 ~2 ~-12 as @e[type=piglin, tag=bastion_mob, dx=4, dy=10, dz=5] run data modify entity @s CustomName set value '{"text":"walls/side_wall_1","color":"yellow"}'