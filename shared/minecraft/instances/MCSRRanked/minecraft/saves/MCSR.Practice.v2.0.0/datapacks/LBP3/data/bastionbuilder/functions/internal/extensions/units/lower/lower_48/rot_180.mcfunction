...
execute if score id_piglins bastion.settings matches 1.. positioned ~-39 ~2 ~-35 as @e[type=piglin, tag=bastion_mob, dx=35, dy=14, dz=29] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'