...
execute if score id_piglins bastion.settings matches 1.. positioned ~-24 ~1 ~-43 as @e[type=piglin, tag=bastion_mob, dx=21, dy=18, dz=39] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'