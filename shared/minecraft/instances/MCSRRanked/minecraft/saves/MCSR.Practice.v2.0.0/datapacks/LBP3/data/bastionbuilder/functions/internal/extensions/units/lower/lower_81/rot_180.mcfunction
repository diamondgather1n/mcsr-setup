...
execute if score id_piglins bastion.settings matches 1.. positioned ~-37 ~2 ~-39 as @e[type=piglin, tag=bastion_mob, dx=34, dy=14, dz=34] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'