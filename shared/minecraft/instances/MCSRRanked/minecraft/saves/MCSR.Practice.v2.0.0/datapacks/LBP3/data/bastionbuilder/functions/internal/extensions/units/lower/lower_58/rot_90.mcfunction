...
execute if score id_piglins bastion.settings matches 1.. positioned ~-43 ~4 ~3 as @e[type=piglin, tag=bastion_mob, dx=41, dy=12, dz=37] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'