...
execute if score id_piglins bastion.settings matches 1.. positioned ~2 ~1 ~-26 as @e[type=piglin, tag=bastion_mob, dx=42, dy=18, dz=22] run data modify entity @s CustomName set value '{"text":"lower","color":"yellow"}'