clone ~ ~ ~ ~ ~1 ~ ~ 254 ~
setblock ~ ~ ~ structure_block{mode:"LOAD", rotation:"CLOCKWISE_180", name:"sp.fortress:corridor/stairs"}
...
execute positioned ~-6 ~-1 ~-3 run function sp.fortress:internal/fill_support
execute positioned ~-6 ~-1 ~-4 run function sp.fortress:internal/fill_support
...
execute positioned ~-7 ~-1 ~-3 run function sp.fortress:internal/fill_support
execute positioned ~-7 ~-1 ~-4 run function sp.fortress:internal/fill_support
...
execute positioned ~-8 ~-1 ~-3 run function sp.fortress:internal/fill_support
execute positioned ~-8 ~-1 ~-4 run function sp.fortress:internal/fill_support
...
execute positioned ~-9 ~-1 ~-3 run function sp.fortress:internal/fill_support
execute positioned ~-9 ~-1 ~-4 run function sp.fortress:internal/fill_support
